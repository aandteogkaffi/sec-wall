...
__all__ = [
    "AUTH_XPATH_NO_DATA",
    "AUTH_XPATH_EXPR_MISMATCH",
    "AUTH_CERT_NO_SUBJECT",
    "AUTH_CERT_NO_VALUE",
    "AUTH_CERT_VALUE_MISMATCH",
    "AUTH_WSSE_NO_DATA",
    "AUTH_WSSE_VALIDATION_ERROR",
    "AUTH_BASIC_NO_AUTH",
    "AUTH_BASIC_INVALID_PREFIX",
    "AUTH_BASIC_USERNAME_OR_PASSWORD_MISMATCH",
    "AUTH_DIGEST_NO_AUTH",
    "AUTH_DIGEST_USERNAME_MISMATCH",
    "AUTH_DIGEST_REALM_MISMATCH",
    "AUTH_DIGEST_URI_MISMATCH",
    "AUTH_DIGEST_RESPONSE_MISMATCH",
    "AUTH_DIGEST_NO_HEADER",
    "AUTH_DIGEST_HEADER_MISMATCH",
    "AUTH_CUSTOM_HTTP_NO_HEADER",
    "AUTH_CUSTOM_HTTP_HEADER_MISMATCH",
]
